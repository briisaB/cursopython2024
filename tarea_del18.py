...
Examen2 = float(input(" ingresar nota del examen 2 (10%): "))
Examen3 = float(input(" ingresar nota del examen 3 (10%): "))
Examen4 = float(input(" ingresar nota del examen 4 (10%): "))
Examen5 = float(input(" ingresar nota del examen 5 (50%): "))
